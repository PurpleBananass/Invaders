...
public class GameScreen extends Screen {
	...
	public final int run() {
		...
		this.score += this.lives - 1 > 0 ? LIFE_SCORE * (this.lives - 1) : LIFE_SCORE * this.lives;
		int quotient = this.score / SCORE_COIN_RATE;//myupdate
		int remainder = this.score % SCORE_COIN_RATE;//myupdate
	...
	private void draw() {
		...
		// Interface.
		drawManager.drawScore(this, this.score, this.coin);
	...
	public final GameState getGameState() {
		return new GameState(this.level, this.score, this.coin, this.lives, this.bulletsShot, this.shipsDestroyed);
	}
}